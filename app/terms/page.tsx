    ...
    <div className="min-h-screen bg-[#0D110D] flex flex-col">
      ...
      <div className="flex-1 overflow-y-auto px-5 py-6 pb-16 max-w-2xl mx-auto w-full">
        ...
        {[
          ...
          {
            title: '5. People Matching, Waves & Paths Crossed',
            body: 'By enabling People Matching in Settings, you consent to your profile being surfaced to other attendees of the same events as a potential match. You can disable this at any time.\n\nWaves: Gathr+ members may send a wave to a match before an event. By sending a wave, you acknowledge that if the recipient is a Gathr+ subscriber, they will see your first name, profile photo, and interests you share with them. You agree to use waves in good faith as a genuine expression of interest in meeting someone at an event. Waves may not be used to harass, target, or intimidate other users. Attempting to use the wave system to identify or profile users beyond the disclosures described above is a violation of these Terms and may result in immediate account termination.\n\nPaths Crossed: Gathr+ members can access a feed of people they have co-attended events with, derived from check-in and RSVP records. By using Gathr, you acknowledge that your attendance at public events (check-ins and RSVPs) may surface you in another Gathr+ user\'s Paths Crossed feed if you share at least one event and have matching_enabled = true. You can prevent this by disabling People Matching in Settings → Privacy.',
          },
          {
          ...
          },
          {
            ...
            body: 'Gathr+ is the premium tier of Gathr. It unlocks: pre-RSVP match preview (see who\'s going before you RSVP), wave sender identity (Gathr+ recipients see the first name, photo, and shared interests of who waved at them), unlimited waves, Paths Crossed history, priority matching rank, Open to Dating Mode, Travel Mode (coming soon), and a Founding Member badge for the first 1,000 paid subscribers.\n\nPricing: Gathr+ plans are $4.99/month or $39.99/year. Billing has not yet launched — subscribers added to the waitlist will be charged only when billing goes live, and will be notified in advance. By joining the waitlist, you agree to be contacted when paid plans become available.\n\nFounding Member badge: The first 1,000 paid subscribers receive a permanent "Founding Member" badge on their profile. This badge is granted once at subscription time, is non-transferable, and remains on the profile permanently even after a subscription lapses.\n\nFree 7-Day Trial: Eligible users (account at least 1 hour old, no prior trial used) may claim a one-time 7-day Gathr+ free trial. No card is required. Access ends automatically when the 7 days expire. The trial may only be claimed once per account; enforced server-side and cannot be bypassed.\n\nLevel-Milestone Previews: Reaching level 5 grants a one-time 48-hour Gathr+ preview; reaching level 10 grants a one-time 7-day preview. These are automatic, non-repeatable rewards — not a paid free trial. They do not renew, cannot be transferred, and expire at the time shown in your profile.\n\nOpen to Dating Mode: Gathr+ subscribers may opt in to Open to Dating Mode in Settings to signal openness to romantic connections. This status is disclosed only to other active Gathr+ subscribers who have also opted in — it appears in the Paths Crossed feed and pre-event match lists between mutually opted-in members. You may toggle this on or off at any time; toggles are rate-limited to prevent abuse. By enabling Open to Dating Mode, you acknowledge that other opted-in Gathr+ members will see that you have indicated openness to romantic connection. Use of this feature to harass, misrepresent your intentions, or pressure other users is a violation of these Terms and grounds for account termination.\n\nCancellation & Refunds: Once paid plans go live, you may cancel Gathr+ at any time and your subscription will remain active until the end of the current billing period. No partial refunds will be issued for unused time. Refund requests may be submitted to support@gathr.app within 48 hours of a charge and will be handled on a case-by-case basis.\n\nFeature changes: We may add, modify, or remove Gathr+ features at any time. Material reductions in features will be communicated in advance.',
          },
          {
