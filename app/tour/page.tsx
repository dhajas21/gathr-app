...
const tourSlides = [
  {
    ...
    tip: 'Swipe through the tabs — Trending, For You, City, Friends, and My Events.',
  ...
  },
  {
    ...
    tip: 'Swipe left on a message to mark it read or unread.',
    bg: 'linear-gradient(135deg,#2A1A1A,#1A0E0E)',
  },
  {
    icon: '🔍',
    title: 'Search & Explore',
    highlight: 'Find anything',
    body: 'Search for events, people, communities, or tags. Filter by category. Try natural language like "live music this weekend."',
    tip: 'Tap the city pill on your home feed to switch locations.',
