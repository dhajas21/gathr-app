...
const tourSlides = [
  {
    ...
    tip: 'Swipe through the tabs — Trending, For You, City, Friends, and My Events. Tap 🔖 on any event to save it.',
  ...
  },
  {
    ...
    tip: 'Add interest tags so the right people find your event. You can also upload a cover photo.',
  ...
  },
  {
    ...
    body: 'Gathr surfaces people going to the same event as you who share your interests. Connect before you go, or get a follow-up after the event ends.',
  ...
  },
  {
    ...
    tip: 'Connection requests show up in your Activity feed (bell on your profile). You can accept, decline, or view the person\'s profile right from the notification.',
  ...
  },
  {
    ...
    body: 'Search for events, people, or tags using natural language like "live music this weekend." Or switch to Map view to explore events near you visually.',
    tip: 'Tap the Map tab in the bottom nav to see events as pins. Tap any pin to preview the event.',
    bg: 'linear-gradient(135deg,#1E2E1E,#2A1A0E)',
  },
  {
    icon: '⭐',
    title: 'XP & Achievements',
    highlight: 'Level up as you go',
    body: 'Every event you host, attend, and connection you make earns XP. Unlock achievements for milestones like First Connection, Social Butterfly, and more.',
    tip: 'Check your level and achievement progress in Profile → Stats tab. Add a photo and write your bio to unlock your first two achievements instantly.',
