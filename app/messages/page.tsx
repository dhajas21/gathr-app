                ...
                <button key={conn.id}
                  ...
                  <div className="relative">
                    {optimizedImgSrc(conn.otherProfile?.avatar_url, 96) ? (
                      ...
                      <div className="w-12 h-12 bg-[#1E3A1E] border border-white/10 rounded-xl flex items-center justify-center text-base font-semibold text-[#7EC87E]">
              ...
              <div className="w-full space-y-2">
                ...
                {acceptedConnections.length > 5 && (
                  <button onClick={() => setShowCompose(true)}
                    ...
                    +{acceptedConnections.length - 5} more — tap the compose button to search
                  </button>
                )}
              </div>
            </>
                  ...
                  .map(conn => (
                    <button key={conn.id}
                      ...
                      {optimizedImgSrc(conn.otherProfile?.avatar_url, 96) ? (
                        ...
                        <div className="w-10 h-10 bg-[#2A4A2A] rounded-xl flex items-center justify-center flex-shrink-0 text-sm font-semibold text-[#7EC87E]">
                          {conn.otherProfile?.name?.charAt(0) || '?'}
                        </div>
                      )}
                      <div className="flex-1 text-left">
